  ...
  return (
    <div className="min-h-screen flex bg-indigo-50">
      ...
      <div className="flex flex-col justify-center bg-white rounded-lg shadow-lg p-10 w-1/2 max-w-md mx-auto my-16">
        ...
        <p className="text-gray-600 mb-8 text-center">Join thousands of satisfied customers</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              id="role"
              className="w-full bg-gray-100 rounded-md border border-gray-200 p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={role}
